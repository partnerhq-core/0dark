...
export function Globe() {
  ...
  return (
    <div className="flex flex-row items-center justify-center bg-neutral-900">
...
function Globe_({ globeConfig, data }: WorldProps) {
  const [globeData, setGlobeData] = useState<Array<{
    size: number
    order: number
...
function World(props: WorldProps) {
  ...
  scene.fog = new Fog(0xff_ff_ff, 400, 2000)
  return (
